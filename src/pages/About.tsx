          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-sm md:text-lg text-muted-foreground leading-relaxed order-1 md:order-2">
              <p>
                ...
                retreat has evolved into a haven for those seeking genuine respite from the relentless demands of modern life.
              </p>
              <p>
                What began as a small, intimate wellness practice has blossomed into a comprehensive sanctuary, offering an extensive menu of
                treatments that thoughtfully blend time-honored healing traditions with cutting-edge contemporary techniques. Every service we provide
                is firmly grounded in evidence-based practices and delivered with the highest level of professional care and personal attention.
              </p>
              <p>
                We believe deeply in sustainability and environmental stewardship, sourcing certified organic and locally-produced products whenever
                possible. Our commitment extends far beyond the treatment room—we're passionately dedicated to creating a lasting positive impact on
                our local community and the environment we all share.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-center text-muted-foreground mb-16 max-w-2xl mx-auto text-lg">
            Our team of highly trained, internationally certified professionals brings expertise, passion, and genuine care to every session, creating
