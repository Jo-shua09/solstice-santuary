    ...
    <div className="min-h-screen">
      ...
      <section className="p-10 md:py-20 px-6">
        <div className="container md:py-0 py-10 rounded-tr-3xl rounded-bl-3xl mx-auto max-w-4xl md:text-center md:border-0 border-2 border-primary">
          ...
          <p className="md:text-lg text-sm text-muted-foreground leading-relaxed mb-6 animate-slide-up">
            ...
            retreat offers a peaceful escape from the demands of modern life. Every treatment is thoughtfully designed and tailored to nurture your
            complete well-being—mind, body, and spirit.
          </p>
          <p className="md:text-lg text-sm text-muted-foreground leading-relaxed md:text-center text-right animate-slide-up">
            Experience the art of relaxation in our carefully curated sanctuary, where natural beauty harmonizes with modern luxury. Our expert
            practitioners blend ancient healing traditions with cutting-edge wellness techniques, using only the finest organic and sustainably
            sourced products. Each visit is a journey toward balance, rejuvenation, and inner peace.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {amenities.map((amenity, index) => (
              <div key={index} className="text-center p-8 bg-card rounded-2xl hover-lift">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-sm md:text-lg text-muted-foreground leading-relaxed mb-4">
                Our most sought-after treatment is a transformative 90-minute journey that combines ancient healing techniques with modern therapeutic
                approaches. This luxurious experience begins with warm volcanic stones placed along your spine to release deep-seated tension and
                promote energy flow.
              </p>
              <p className="text-sm md:text-lg text-muted-foreground leading-relaxed mb-4">
                Our master therapists use a carefully curated blend of aromatic essential oils—including lavender, bergamot, and ylang-ylang—while
                applying gentle acupressure to key meridian points. The treatment incorporates Swedish massage techniques, myofascial release, and
                energy balancing to address both physical tension and energetic blockages.
              </p>
              <p className="text-sm md:text-lg text-muted-foreground leading-relaxed mb-6">
                Each session concludes with a calming scalp massage and warm herbal tea, leaving you in a state of profound relaxation and inner
                peace. Many guests report improved sleep, reduced stress, and a renewed sense of vitality that lasts for weeks.
              </p>
              <Link to="/services/signature-massage">
                <Button className="bg-primary text-primary-foreground hover:bg-primary/90 mr-4">Discover More</Button>
              </Link>
      ...
      <section className="py-20 md:px-6 bg-primary text-primary-foreground">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl md:text-5xl font-serif font-semibold mb-6">Begin Your Wellness Journey</h2>
          <p className="text-xl mb-8 opacity-90">Reserve your sanctuary experience today and discover the art of complete relaxation.</p>
          <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 text-lg px-8 py-6" onClick={() => setIsBookingOpen(true)}>
            Book Now
          </Button>
        </div>
